        ...
        <div className="max-w-4xl translate-y-[60px]">
          ...
          >
            ...
            >
              <Link 
                to="/commercial"
                className="inline-flex items-center text-white hover:text-white transition-all text-base font-medium px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm hover:bg-white/20 shimmer-text"
              >
            ...
            >
              <a 
                href={`tel:${phone}`}
                className="flex items-center justify-center space-x-3 px-8 py-4 text-lg font-semibold bg-primary-600 hover:bg-primary-700 rounded-lg shadow-lg hover:shadow-xl transition-all transform hover:scale-105 text-white"
              >
                <Phone className="w-6 h-6" />
                <div className="text-left">
                  <div className="text-xs text-white/90">{hero.primaryButtonText}</div>
                  <div>{phone}</div>
                </div>
              </a>
              <Button 
