...
import { Wrench, Thermometer, Wind, CheckCircle, Phone, ArrowRight } from 'lucide-react';
...
const HeatingServices = () => {
  const service = serviceData.heating;
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                className="flex items-center justify-center space-x-2 px-6 py-3 bg-white text-orange-600 rounded-lg font-semibold hover:bg-orange-50 transition-colors"
              >
      ...
      <section className="section-padding bg-gradient-to-br from-orange-500 to-red-600 text-white">
        <div className="container-custom text-center">
          ...
          <p className="text-xl text-orange-100 mb-8 max-w-2xl mx-auto">
            Don't wait until your heating system fails. Schedule service today or call for immediate assistance.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href={`tel:${companyData.phone}`}
              className="flex items-center justify-center space-x-2 px-8 py-4 bg-white text-orange-600 rounded-lg font-semibold hover:bg-orange-50 transition-colors text-lg"
            >
              <Phone className="w-5 h-5" />
