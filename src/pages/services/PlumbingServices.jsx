...
import { Wrench, Droplet, Flame, AlertCircle, CheckCircle, Phone } from 'lucide-react';
...
const PlumbingServices = () => {
  const service = serviceData.plumbing;

  return (
    <div className="min-h-screen">
      {/* Hero */}
      <section className="bg-gradient-to-br from-blue-600 via-primary-600 to-blue-700 text-white py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {service.commonProblems.map((item, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="bg-gradient-to-br from-blue-50 to-primary-50 rounded-lg p-6 border border-blue-200"
              >
      ...
      {/* CTA Section */}
      <section className="section-padding bg-gradient-to-br from-blue-600 to-primary-700 text-white">
